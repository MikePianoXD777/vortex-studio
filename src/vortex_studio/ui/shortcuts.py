...
DEFAULTS: dict[str, tuple[str, str]] = {
    ...
    "editar.copiar": ("Copiar", "Ctrl+C"),
    "editar.cortar_copia": ("Cortar al portapapeles", "Ctrl+X"),
    ...
    "marcar.marcador_nombre": ("Editar marcador", "Shift+M"),
    "marcar.marcador_clip": ("Poner marcador en el clip", "Alt+Shift+M"),
